        ...
        <header class="header">
            ...
            <div class="header__content">
                <div class="header__caption">
                    ...
                    <a href="#"><button type="submit" class="header__btn">Buy now</button></a>    
                </div>
        ...
        <section class="order block">
            <div class="order__body">
                ...
                <form action="#" class="form">                        
                    ...
                    <input type="text" placeholder="Type your surname" autocomplete="off"/>                       
                    <input type="text" placeholder="Type your e-mail" autocomplete="off"/>
